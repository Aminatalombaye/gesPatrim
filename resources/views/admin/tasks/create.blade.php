    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tasks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('equipements') ? 'is-invalid' : '' }}" name="equipements[]" id="equipements" multiple>
                    @foreach($equipements as $id => $equipement)
                        <option value="{{ $id }}" {{ in_array($id, old('equipements', [])) ? 'selected' : '' }}>{{ $equipement }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('scheduled_date') ? 'is-invalid' : '' }}" type="text" name="scheduled_date" id="scheduled_date" value="{{ old('scheduled_date') }}" required>
