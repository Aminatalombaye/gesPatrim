    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.infrastructures.update", [$infrastructure->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $infrastructure->description) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $infrastructure->status) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $infrastructure->location) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('construction_date') ? 'is-invalid' : '' }}" type="text" name="construction_date" id="construction_date" value="{{ old('construction_date', $infrastructure->construction_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('depreciation_plan') ? 'is-invalid' : '' }}" type="text" name="depreciation_plan" id="depreciation_plan" value="{{ old('depreciation_plan', $infrastructure->depreciation_plan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $infrastructure->type) }}">
                @if($errors->has('type'))
                    <div class="invalid-feedback">
                        {{ $errors->first('type') }}
                    </div>
