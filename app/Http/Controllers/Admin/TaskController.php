...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        $tasks = Task::with(['status', 'tags', 'assigned_to', 'equipements', 'media'])->get();
    ...
    public function store(StoreTaskRequest $request)
    {
        ...
        $task->equipements()->sync($request->input('equipements', []));
    ...
    public function edit(Task $task)
    {
        ...
        return view('admin.tasks.edit', compact('assigned_tos', 'equipements', 'statuses', 'tags', 'task'));
    }
